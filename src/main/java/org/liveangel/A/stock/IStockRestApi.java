...
//                        String price, String amount) throws  IOException;
//
//	/**
//	 * 批量下单
//	 * @param symbol   btc_usd: 比特币 ltc_usd: 莱特币
...
//                              String orders_data) throws  IOException;
//
//	/**
//	 * 撤销订单
//	 * @param symbol  btc_usd: 比特币 ltc_usd: 莱特币
...
//	 * @throws IOException
//	*/
//	public String cancel_order(String symbol, String order_id) throws  IOException;
//
//	/**
//	 * 获取用户的订单信息
//	 * @param symbol  btc_usd: 比特币 ltc_usd: 莱特币
...
//	 * @throws IOException
//	*/
//	public String order_info(String symbol, String order_id) throws  IOException;
//
//	/**
//	 * 批量获取用户订单
...
//                              String order_id) throws IOException;
//
//	/**
//	 * 获取历史订单信息，只返回最近七天的信息
//	 * @param symbol btc_usd: 比特币 ltc_usd: 莱特币
...
//                                String current_page, String page_length) throws  IOException;
